...
require 'C:/Program Files (x86)/EasyPHP-Devserver-17/eds-www/doctor-pet/src/PHPMailer/src/Exception.php';
require 'C:/Program Files (x86)/EasyPHP-Devserver-17/eds-www/doctor-pet/src/PHPMailer/src/PHPMailer.php';
require 'C:/Program Files (x86)/EasyPHP-Devserver-17/eds-www/doctor-pet/src/PHPMailer/src/SMTP.php';
...
function envia_email($para, $assunto, $mensagem){
    ...
    try {
        ...
        $mail->Username   = 'doctorpet13@gmail.com';               //usuário SMTP
        $mail->Password   = 'ccvdxvpdnubonkfx';                     //senha SMTP
        ...
        $mail->setFrom('doctorpet13@gmail.com', 'Doctor Pet');  // Adiciona o remetente
